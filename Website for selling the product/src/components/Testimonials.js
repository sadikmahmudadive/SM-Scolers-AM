...
const testimonials = [
  {
    ...
    text: "SM Scolers transformed how we track attendance. The biometric scanning is incredibly fast, and the real-time sync means I always have up-to-date data. The SMS alerts give parents peace of mind.",
    rating: 5,
  },
  {
    name: "John Mwangi",
    role: "IT Manager",
    org: "TechBridge Institute",
    text: "The auto-reconnect feature is a game-changer. Even when our network drops, the system catches up automatically. I never worry about missing records anymore.",
    rating: 5,
  },
  {
    name: "Fatima Ali",
    ...
    text: "Generating PDF reports used to take hours. Now I can get detailed attendance reports in seconds. The dashboard is beautiful and easy to understand at a glance.",
    rating: 5,
  },
  {
    name: "David Ochieng",
    ...
    text: "We deployed SM Scolers across three campuses. The Firebase sync keeps everything in one place. Best attendance investment we've made.",
    rating: 5,
  },
];
